...
class SpeciesKineticsFrame(Frame):
    ...
    def makeEntries(self):
        ...
        for sp in DATAKEYS:
            ...
            l = SpeciesInfo(self.entries, species=s, text=spname, relief=FLAT,
                            justify=RIGHT, fg='darkblue')
...
class ReactionKineticsFrame(Frame):
    def __init__(self, vis, top):
       ...
       #                    orient='horizontal',length=400)
        self.sc = Scale(self.scfr, command=self.show, variable=self.start,
...
class ReactionPathFrame(Frame):
    def __init__(self, top):
        ...
        scframe = Frame(self)
        self.sc = Scale(scframe, variable=self.thresh, orient='horizontal',
        ...
        for e in enames:
            Radiobutton(eframe, text=e, variable=self.el, value=i - 1,
        ...
        for e in ['svg', 'png', 'gif', 'jpg']:
            Radiobutton(fmtframe, text=e, variable=self.fmt, value=e,
        ...
        Entry(pframe, width=60, textvariable=self.dot).grid(column=0, row=1, sticky=W)
    ...
    def show(self, e=None):
        ...
        if self.browser.get() == 1:
            ...
            try:
                ...
                self.image = self.cv.create_image(0, 0, anchor=NW, image=self.rp)
            except:
                pass
